...
export async function getGmailMails(accessToken?: string): Promise<MailItem[]> {
  ...
  return [
    ...
    },
    {
      ...
      senderName: "나 (zollove@gmail.com)",
      senderEmail: "zollove@gmail.com",
      subject: "[발신] 8월 2주차 파스텔골프클럽 시스템 개선 및 기술 보완 내역 보고",
      snippet: "파스텔골프클럽 운영팀 귀하. 8월 2주차 메일 서버 및 전산 데이터베이스 개선 보고서입니다.",
      body: "수신: pastel_club@naver.com\n발신: zollove@gmail.com\n\n8월 2주차 시스템 개편 완료 보고서 첨부합니다.",
    ...
    },
    {
      ...
      senderName: "나 (zollove@gmail.com)",
      senderEmail: "zollove@gmail.com",
      subject: "[발신] 8월 1주차 영업 실적 및 결산 데이터 공유",
      snippet: "8월 1일 파스텔골프클럽 8월 첫째 주 결산 실적 자료입니다.",
      body: "수신: management@pastelgolf.co.kr\n발신: zollove@gmail.com\n\n8월 1주차 매출 결산표 첨부합니다.",
    ...
    },
    {
      ...
      provider: "gmail",
      accountEmail: "zollove@gmail.com",
      senderName: "Google Workspace Admin",
      senderEmail: "admin@google.com",
      subject: "[Google Workspace] 8월 정기 보안 및 도메인 업데이트 통지",
      snippet: "2026년 8월 1일 자 Google Workspace 정기 보안 업데이트가 안전하게 완료되었습니다.",
      body: "8월 정기 점검이 이상 없이 완료되었습니다.",
