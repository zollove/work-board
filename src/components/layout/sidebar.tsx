...
import { Calendar, Building2, StickyNote, Contact2, GitFork, Images, Calculator, Wrench, PanelLeftClose, PanelLeftOpen } from "lucide-react";
...
const navItems = [
  ...
  { name: "부동산/업무 계산기", href: "/calculators", icon: Calculator },
