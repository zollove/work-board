...
import {
  ...
  Calculator, ChevronLeft, ChevronRight, PanelLeftClose, PanelLeftOpen,
  Contact2, Library, ShieldCheck, KeyRound, Lock, Unlock, Settings, ChevronDown, ChevronUp, Compass, Mail, HardDrive, Newspaper,
  Radio, Briefcase,
} from "lucide-react";
